...
**\$ mv shithead ~/my_path/shithead/.**

If you want to create a desktop shortcut (Ubuntu), also move the desktop-file and the icon to this directory:

**\$ mv shithead.desktop ~/my_path/shithead/.**  
**\$ mv shithead4.ico ~/my_path/shithead/.**
...
Move shithead.exe to this folder.
...
**Type the location of the item: D:\Games\Shithead\shithead.exe -> 'Next'**  
