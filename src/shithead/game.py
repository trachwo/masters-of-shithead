...
def initial_tests():
    ...
    state.players[1].take_card('HAND', Card(0, 'Diamonds', '5'))
    state.players[1].take_card('HAND', Card(0, 'Hearts', '10'))
    state.players[1].take_card('HAND', Card(0, 'Hearts', '8'))
    print('Discard: ', end='')
    state.discard.print_top()
    state.players[1].print(visibility=3)
    ...
    state.players[1].hand = Deck(empty=True)
    state.players[1].take_card('HAND', Card(0, 'Clubs', '5'))
    state.players[1].take_card('HAND', Card(0, 'Hearts', '10'))
    state.players[1].take_card('HAND', Card(0, 'Spades', '2'))
    print('Discard: ', end='')
    state.discard.print_top()
    state.players[1].print(visibility=3)
    plays = state.get_legal_plays()
