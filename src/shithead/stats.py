...
class Statistics():
    ...
    def __init__(self):
        ...
        # name of last Shithead => dealer of next game
        self.shithead = None
    ...
    def revert(self, name, score, turns):
        '''
        Revert player's score, turn count, and game count.

        If a round of the game has to be aborted, because to many turns have
        been played (AI deadlock) the statistics for this round have to be
        annullated. Since statistics are updated whenver a player went out, we
        have to revert the statistics of these players.
        NOTE: there's no need for reverting the shithead counter, since there's
              no shithead in an aborted game.
